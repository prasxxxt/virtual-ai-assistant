...
class TrainingModel:
    ...
    # Defining train function to train model
    def train(self):
    ...
    # Defining get intent function to process command and return predicted intent
    ...
    # Defining bag of words function to process command
    ...
    # Defining clean text function to tokenize and lemmmatize text
    ...
    # Defining function to get response of corresponding intent
    @staticmethod
